...
CREATE TYPE move_status_enum AS ENUM ('CREATED', 'OFFER_SENT', 'OFFER_AVAILABLE', 'ACCEPTED', 'REJECTED', 'CANCELLED', 'SCHEDULED', 'IN_PROGRESS', 'COMPLETED', 'PENDING', 'CONFIRMED', 'PAYMENT_COMPLETED', 'REFUNDED');
