...
with open('Scripts/seed_data.sql', 'w') as f:
    ...
    # Vehicle types
    f.write("INSERT INTO vehicle_types (id, type, max_weight, capacity) VALUES\n")
    vt_values = [
    ...
    # Luggage types
    f.write("INSERT INTO luggage_types (id, type, name, volume, weight) VALUES\n")
    lt_values = [
    ...
    # Driver infos
    f.write("INSERT INTO driver_infos (id, driving_experience, range, driving_license, user_id) VALUES\n")
    di_values = []
    ...
    # Vehicles
    f.write("INSERT INTO vehicles (id, model, make, year, color, price_per_km, is_active, can_carry_furniture, driver_id, vehicle_type_id) VALUES\n")
    veh_values = []
    for v in vehicles:
    ...
    # Move requests
    f.write("INSERT INTO move_requests (id, move_date, max_budget, client_id, from_address_id, to_address_id, status) VALUES\n")
    mr_values = []
    for mr in move_requests:
    ...
    # Luggage entries
    f.write("INSERT INTO luggage_entries (id, quantity, move_request_id, luggage_type_id) VALUES\n")
    le_values = []
    ...
    # Move offers
    f.write("INSERT INTO move_offers (id, price, offered_date, move_request_id, driver_id, vehicle_id, status) VALUES\n")
    mo_values = []
    for mo in move_offers:
    ...
    # Move trips
    f.write("INSERT INTO move_trips (id, move_request_id, move_offer_id, status) VALUES\n")
    mt_values = []
